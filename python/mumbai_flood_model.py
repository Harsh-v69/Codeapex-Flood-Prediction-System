...
DATA_ROOT = PROJECT_ROOT / "data" / "mumbai"
...
DEM_TILES = [
    str((PROJECT_ROOT / "data" / "n19_e072_1arc_v3.tif").resolve()),
    str((PROJECT_ROOT / "data" / "n19_e073_1arc_v3.tif").resolve()),
]
...
# Paths
FLOOD_CSV_PATH    = str((DATA_ROOT / "mumbai_flood_dataset.csv").resolve())
RAINFALL_CSV_PATH = str((DATA_ROOT / "mumbai_rainfall.csv").resolve())
GEOJSON_PATH      = str((DATA_ROOT / "drainagemumbai.geojson").resolve())
MODEL_SAVE_PATH   = str((OUTPUT_ROOT / "mumbai_flood_model.pkl").resolve())
